defmodule SmartChain do
  @moduledoc """
  This library presents a convenient interface to control a full SmartChain node from Elixir, 
  ...
  """
  alias SmartChain.Web3
  alias SmartChain.Eth
  alias SmartChain.Net
  alias SmartChain.Personal
  alias SmartChain.Aggregates
  alias SmartChain.HexUtils
  alias SmartChain.ABI
  alias SmartChain.TxPool
