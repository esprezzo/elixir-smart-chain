defmodule SmartChain.HexUtils do
  require Logger
  @moduledoc """
  ...
  @doc "Converts smart_chain hex string to decimal number"
  ...
  @doc """
  Does this look like a valid SmartChain address?

  ## Example: 

      iex>  SmartChain.is_valid_address?("0x")
      false
