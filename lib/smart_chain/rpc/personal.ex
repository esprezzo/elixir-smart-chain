defmodule SmartChain.Personal do
  @moduledoc """
    Personal namespace for SmartChain JSON-RPC
  ...
  @doc """
  Create new account to be managed by connected SmartChain node with password/password confirmation

  ## Example: 

      iex> SmartChain.new_account("p@55w0rd","p@55w0rd")
  ...
  @doc """
  Unlock account account on conected SmartChain node
  ...
  @doc """
  Lock account account on conected SmartChain node
  ...
  ## Example:
      ...
      ...> amount = 0.5
      ...> password = ""
      ...> Enum.each(1..1000, fn x -> SmartChain.send_transaction(sender, receiver, amount, password) end)
      ...> - OR -
      ...> SmartChain.send_transaction(sender, receiver, amount, password)
  ...
  def send_transaction(from, to, value, password) do
    ...
    Logger.warn "XXXXXX TODO: fix gas: wei value to send: #{wei_value}"
    params = [%{
      "from": from,
      "to": to,
      "gas": "0x186a0", # 100k,
