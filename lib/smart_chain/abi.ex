defmodule SmartChain.ABI do
  ...
  @doc "Encodes data into SmartChain hex string based on types signature"
  ...
  @doc "Encodes options into SmartChain JSON RPC hex string"
  ...
  def keys_to_decimal(map, keys) do
    for k <- keys, into: %{}, do: {k, map |> Map.get(k) |> SmartChain.hex_to_decimal()}
  end
